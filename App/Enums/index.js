...
exports.GenerateDiffs = (LeftReview, RightReview) => {
    ...
    const LeftFragment = LeftReview.find(fragment => fragment.fragment_name === 'Enumerations');
    const LeftItems = LeftFragment.review_data.Enumerations;

    const RightFragment = RightReview.find(fragment => fragment.fragment_name === 'Enumerations');
    const RightItems = RightFragment.review_data.Enumerations;
